...
public class WebTableTests extends TestBase {
    ...
    public void printTableTest() {
        WebElement table = driver.findElement(By.id("table1")).findElement(By.tagName("thead"));
    ...
    public void countRowsTest() {
        //means find with id table1 then go to tbody and tr
    ...
    //get number of rows in the second table, including header
    @Test
    ...
    /*
    TASK: Pront all column names from table1
    ...
    public void verifyThatNameDisplays() {
        ...
        String lastName = "Doe";
        String firstNameLocator = "//table[1]//tbody//tr[1]";
    ...
    public void verifyThatRRecordHasBeenDeletedTest() {
        String firstName = "Jason";
        String lastName = "Doe";
        String firstNameLocator = "//table[1]//tbody//tr[1]";
        String lastNameLocator = "//table[1]//tbody//tr[3]//td[2]";
    ...
    public List<String> getColumn(String columnName) {
        ...
        //based on position that we found in previous loop, we're allocating column
