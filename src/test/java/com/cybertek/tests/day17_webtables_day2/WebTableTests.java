...
public class WebTableTests extends TestBase {
    ...
    /**
     * Let's write a method that will return table header as a List of web elements
     */
    ...
    public void getHeadersTest() {
        ...
        Assert.assertEquals(getHeadersText(), expectedColumnNames, "Column names doesn't match");
    }
    ...
    public List<String> getColumnData(String columnName) {
        ...
        //This is a collection of webelements that contains values from specific column
        List<WebElement> columnCollecttionOfWebElements = driver.findElements(By.xpath(locatorForColumn));
        List<String> columnCollectionOfText = new ArrayList<>();
        for (WebElement element : columnCollecttionOfWebElements) {
